        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <a href="<?= base_url('/admin/users_management') ?>" class="btn btn-outline-dark"><i class="fas fa-arrow-left"></i> Back to list</a>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card mb-4 text-center">
                                                <div class="card-body">
                                                    ...
                                                    <?php
                                                    $profileImage = (!empty($user->profile_picture)) ? $user->profile_picture : 'Assets/images/user.png';
                                                    ?>
